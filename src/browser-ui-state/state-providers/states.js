export default {
    ...
    STATIC:                   'STATIC', //e.g. browser doesn't resize it's window content when it's bars get displayed or hidden, or the bars are static and doesn't disappear at all; used only for browsers which are known to behave like this, no programmatic way to detect this in other way
