...
//ToDo add lock screen button and manual refresh button
class BrowserUiStateDemo {
    ...
    updateUi() {
        ...
        const html5FullscreenBtn = document.getElementById('html5FullscreenBtn')
        html5FullscreenBtn.disabled = !html5FullscreenIsAvailable
        html5FullscreenBtn.addEventListener('click', event => fscreen.fullscreenElement ?
